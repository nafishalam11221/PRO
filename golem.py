...
TOKEN = '7907214761:AAGtjBjt8ZEOy4aEQx7WHtC43-yBf2afPqs'
MONGO_URI = 'mongodb+srv://Bishal:Bishal@bishal.dffybpx.mongodb.net/?retryWrites=true&w=majority&appName=Bishal'
FORWARD_CHANNEL_ID = -1002455011955          #telegram mai group bana ke chat id dalo      
CHANNEL_ID = -1002455011955                      #telegram mai group bana ke chat id dalo      
error_channel_id = -1002455011955                   #telegram mai group bana ke chat id dalo      
...
def approve_or_disapprove_user(message):
    ...
    if action == '/approve':
        ...
        msg_text = (f"*💫Congratulations💫*\n"
                    ...
                    f"*Welcome to ignite ddos world✨*")
    else:  # disapprove
        users_collection.update_one(
            {"user_id": target_user_id},
...
def handle_attack_command(message):
    ...
    try:
        ...
        bot.send_message(chat_id, "*💣JALDI ATTACK MAAR BAHI KISI NE BHI NI LAGA RAKHA *\n"  # Ready to launch message
                                   ...
                                   "*OWNER @IGNITE_OWNER_1🧛*", parse_mode='Markdown')  # Start chaos message
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, f"*🚀PING DEKH NICHE 677 HOGYA !👻*\n\n"  # Attack launched message
                                           f"*TIME ==> {duration} seconds send feedback to @IGNITE_OWNER_1🔥*", parse_mode='Markdown')  # Duration message
...
def start_message(message):
    try:
        bot.send_message(message.chat.id, "*🌍 WELCOME TO IGNITE DDOS WORLD!* 🎉\n\n"
...
if __name__ == "__main__":
    ...
    logging.info("Bot started join @IGNITE_OWNER_1...")
    while True:
        try:
